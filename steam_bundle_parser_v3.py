...
import re
# Updated at 19/02/2025: Импорт компонента для красивого отображения сложных структур данных (например, словарей)
...
def main():
    ...
    print('Структура спарсенного товара:')
